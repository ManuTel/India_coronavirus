...
<script>
$('.navbar-logo').wrap('<a href="https://cognitivecare.com/">');
</script>
...
**Updated on on 19.03.2020 at 05:00 PM**

### Sources {.no-title}
**Sources**

1. [Ministry of Health and Family Welfare | Govt. of India](https://www.mohfw.gov.in/) 
2. [Indian Council of Medical Research | Govt. of India](https://www.icmr.nic.in/) 


### Chart C:select state or ut (shiny selectbox){.value-box}

```{r}

valueBox(value = prettyNum(13316, big.mark = ","),
         caption = "Total number of samples tested for SARS-CoV2", 
         icon = "fas fa-vial")
```
